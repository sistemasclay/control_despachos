...
function grafica_oee_maquina($indicadores,$valores)
{
	// Some data
	$datay=array(1,1,300);
  ...
  function pdf_grafico_oee_maquina($sql,$inf)
    {
		//  echo $sql."<br>";
		include("conexion.php");
		$result=$conexion_pg->Execute($sql);
		...
		$pdf->Cell(80);
		$pdf->Cell(40,8,'Grafico OEE para',0,0,'C',true);
		//$pdf->Ln();
		$pdf->Cell(5);
		$pdf->Cell(40,8,$result->fields['nombre'].", ".$inf,0,0,'L',true);
		...
		*/
		...
		$this->grafica_oee_maquina($indicadores,$valores);
